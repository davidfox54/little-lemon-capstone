        ...
        <section id='reservations'>
            <div className='reservations-container container'>
                ...
                <form>
                    ...
                    <label htmlFor='res-time' className='res-label'>
                        Choose time
                    </label>
                    ...
                    <label htmlFor='guests' className='res-label'>
                        Number of guests
                    </label>
                    <input
                        type='number'
                        ...
                        className='res-input'
                    />
                    <label htmlFor='occasion' className='res-label'>
                        Occasion
                    </label>
                    ...
                    <button type='submit' className='btn btn-submit'>
                        <Link to='/reservation-confirmation' className='link-button'>
